...
const appLogoImgPath = 'assets/logos/logo.png';
// User
...
const appPageTagAuthLogin = 'Autenticação';
const appPageTagAuthRegister = 'Registro';
...
const appUnitsMeasureListPageTag = 'Unidades de Medidas';
...
// Colors
const Color appBackgroundColor = Color.fromRGBO(58, 66, 86, 1.0);
const Color appGreyColor = Color.fromRGBO(64, 75, 96, .9);

const Color appPrimaryColor = Color.fromARGB(255, 77, 68, 241);
const Color appGrey400 = Color(0xFFBDBDBD);
const Color appGrey600 = Color(0xFF757575);

// Strings
const appTitle = "SiGeS";
